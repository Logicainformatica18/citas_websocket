...
export default function JobDemandGeoHeader({ meta }: HeaderProps) {
  ...
  const activePeriod: "s1" | "s2" =
    meta.period === "s1" || meta.period === "s2" ? meta.period : "s2";
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <div className="space-y-6 max-w-3xl">
            ...
            <p className="text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
              Análisis geográfico de la demanda laboral, basado en el volumen
              real de vacantes publicadas por ciudad y su nivel de
            ...
            <div className="flex flex-wrap items-end gap-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group rounded-xl border bg-white shadow-sm transition-all hover:border-teal-400 hover:shadow-md hover:-translate-y-[1px]">
                  <select
                    value={meta.year}
                    onChange={(e) =>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex rounded-xl border bg-white shadow-sm overflow-hidden transition-all hover:border-teal-400 hover:shadow-md dark:bg-[#0F2A3A]">
                  {[
                    { value: "s1", label: "Ene – Jun" },
                    { value: "s2", label: "Jul – Dic" },
                  ].map((s) => {
                    const active = activePeriod === s.value;
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="
                      ...
                      shadow-md transition hover:shadow-xl hover:border-teal-400
                      dark:bg-[#102C3C]
                    "
                >
          ...
          {/* ================= RIGHT – METODOLOGÍA ================= */}
          <div className="w-full max-w-sm rounded-2xl border border-teal-400/40 bg-white p-5 text-left shadow-xl dark:bg-[#102C3C]">
            ...
            <div className="mt-4 border-t border-teal-400/20 pt-4">
              <button
                onClick={rebuildAlignment}
                className="
        w-full flex items-center justify-center gap-2
        rounded-xl border border-teal-400/40
        bg-teal-50 dark:bg-[#0A2540]
