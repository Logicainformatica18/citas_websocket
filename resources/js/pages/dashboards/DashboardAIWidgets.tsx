...
export default function DashboardAIWidgets() {
    ...
    if (loading)
        return (
            <div className="text-[#0A4E61] text-sm animate-pulse">
    ...
    if (!widgets.length)
        return (
            <div className="text-[#0A4E61] text-sm">
        ...
        <div className="mt-6 pb-16">   {/* 👈 padding inferior agregado */}
            <div className="mb-4 flex justify-between items-center">
                ...
                <button
                    ...
                    className="bg-[#1CBCE8] hover:bg-[#1399BE] text-white px-3 py-2 rounded shadow-lg transition-all duration-200"
                >
                    ➕ Nueva Sección
                </button>
                ...
                <button
                    ...
                    className="bg-[#0F748F] hover:bg-[#0A4E61] text-white px-3 py-2 rounded shadow flex items-center gap-2 disabled:opacity-50 transition-all duration-200"
                >
                    {updatingAll ? (
                        <>
            ...
            <div id="dashboard-root" className="w-full px-6">
                ...
                relative
                bg-[#052933]                   /* fondo */
                border border-[#0A4E61]         /* borde */
                rounded-lg
                p-6
                flex flex-col justify-center items-center
                text-center
                w-full
                shadow-md hover:shadow-xl       /* sombra */
                transition-all duration-300
            "
                                >
                                    <h2 className="text-2xl font-bold text-[#1CBCE8] tracking-wide drop-shadow-lg">
                                        {item.title}
                                    </h2>

                                    {item.description && (
                                        <p className="text-[#A7E5F6] text-sm mt-1">{item.description}</p>
                                    )}
                ...
                "
                        ...
                        return (
                            <div
                                ...
                                className="rounded-lg shadow-lg hover:shadow-xl bg-white border border-[#D5F3FB] transition-all duration-200"
                            >
