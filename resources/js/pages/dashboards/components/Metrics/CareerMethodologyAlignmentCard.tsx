...
import CareerMethodologyFilters from "./CareerMethodologyFilters";
import {
  ResponsiveContainer,
  BarChart,
  Bar,
...
export default function CareerMethodologyAlignmentCard() {
  ...
  const fieldLabels: Record<string, string> = {
    alineacion_metodologias: "Alineación total",
  };
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const res = await axios.get("/api/ai/career-methodology-alignment/data", {
        params: queryParams,
      });
  ...
  useEffect(() => {
    axios
      .get("/api/ai/career-methodology-alignment/metadata")
  ...
  const handleExport = (format: "excel" | "pdf") => {
    ...
    window.open(
      `/api/ai/career-methodology-alignment/export?${query.toString()}`,
      "_blank"
    );
  };
