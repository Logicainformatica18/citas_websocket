...
export default function CareerLanguageAlignmentCard() {
  ...
  const fieldLabels: Record<string, string> = {
    alineacion_lenguajes: "Alineación total",
    demanda_relativa: "Demanda relativa",
  };

  const fieldColors: Record<string, string> = {
    alineacion_lenguajes: "#22c55e",
    demanda_relativa: "#3b82f6",
  };
  ...
  // Determinar si es vista temporal o snapshot
  const isTemporal = filters.group_by === "week" || filters.group_by === "month";
