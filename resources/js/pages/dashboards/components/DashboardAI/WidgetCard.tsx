...
>
                        ...
                        >
                            {normalizedData.map((entry, index) => {
                                ...
                                const color = ISIL_CHART_PALETTE[index % ISIL_CHART_PALETTE.length];
  ...
  type="monotone"
  dataKey={key}
  stroke={ISIL_CHART_PALETTE[i % ISIL_CHART_PALETTE.length]}
  strokeWidth={2}
/>
                        ...
                        <PieChart>
                            ...
                            >
                                {filteredData.map((entry, index) => (
                                  <Cell
  key={index}
  fill={ISIL_CHART_PALETTE[index % ISIL_CHART_PALETTE.length]}
/>
