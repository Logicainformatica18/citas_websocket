...
const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Carreras Profesionales', href: '/careers' },
];
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <div className="p-8 text-white">
        <h1 className="text-2xl font-bold mb-6">Carreras Profesionales</h1>
                ...
                <tr key={item.id} className="hover:bg-slate-700/40">
                  ...
                  <td className="px-4 py-2 whitespace-nowrap flex gap-2">
                    <button
                      ...
                      className="text-blue-400 hover:text-blue-600 inline-flex items-center gap-1"
                    >
                  ...
                  <td className="px-4 py-2">{item.duration_years ?? "-"}</td>
                  <td className="px-4 py-2 text-center">{item.courses_count ?? 0}</td>
                  <td className="px-4 py-2">
                    {item.active ? (
                      <span className="px-2 py-1 text-xs rounded-full bg-green-700 text-white">Activa</span>
                    ) : (
                      <span className="px-2 py-1 text-xs rounded-full bg-slate-600 text-slate-100">Inactiva</span>
                    )}
                  </td>
