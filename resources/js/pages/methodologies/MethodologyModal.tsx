...
export default function MethodologyModal({
  ...
  const [form, setForm] = useState<Methodology>({ name: "", context_id: null });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editing) {
        // ✏️ Actualización
        await axios.put(`/methodologies/${editing.id}`, form);
        Swal.fire({
          title: "Metodología actualizada",
          text: "La metodología se modificó correctamente.",
          icon: "success",
          timer: 2000,
        ...
        // 🆕 Creación
        await axios.post("/methodologies", form);
        Swal.fire({
          title: "Metodología creada",
          text: "La nueva metodología se registró correctamente.",
          icon: "success",
          timer: 2000,
          showConfirmButton: false,
          background: document.documentElement.classList.contains("dark")
      ...
      console.error("Error al guardar metodología", err);
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-slate-800 dark:text-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
        ...
        <h2 className="text-xl font-bold mb-4">
          {editing ? "Editar Metodología" : "Nueva Metodología"}
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Scrum, Kanban, Agile"
              required
