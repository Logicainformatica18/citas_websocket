...
interface WeeklyEvolutionLanguagesModalProps {
  open: boolean;
  onClose: () => void;
}

export function WeeklyEvolutionLanguagesModal({
  open,
  onClose,
}: WeeklyEvolutionLanguagesModalProps) {
  ...
  */
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "/dashboard/ranking/languages/weekly",
        {
          params: {
            page,
            per_page: 5,
            ...
            <div className="flex items-start justify-between gap-5">
              ...
              <div>
                ...
                <p
                  ...
                  "
                >
                  Top lenguajes por demanda laboral
                  en el sector IT
                </p>
