...
const filters = pageProps?.filters ?? {};
  ...
  return (
    <header className="relative border-b bg-gradient-to-br from-[#E6F7FD] to-[#D9F3FB] dark:from-[#0A2540] dark:to-[#081A2C] px-6 py-10">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#00B6E8] shadow-lg">
              <Globe2 className="h-6 w-6 text-white" />
            </div>

            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#005F7A] dark:text-[#7DD3FC]">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl bg-white dark:bg-slate-800 p-6 shadow-lg hover:shadow-xl transition">
            <div className="flex items-center justify-between">
              ...
              <Calendar className="h-8 w-8 text-[#00B6E8]" />
            </div>
          </div>
