            ...
            "
                    >
                        ...
                        <div className="space-y-1 text-sm text-[#0A2540] dark:text-gray-300">
                            <p>
                                <span className="font-bold text-[#00B6E8]">60%</span>{" "}
                                Demanda laboral (ofertas reales)
                            </p>
                            <p>
                                <span className="font-bold text-[#00B6E8]">40%</span>{" "}
                                Reportes internacionales
                            </p>
                        </div>

                        <p className="mt-3 text-xs text-[#0A2540]/70 dark:text-gray-400">
                            Score = (0.6 × Demanda laboral) + (0.4 × Reportes)
                        </p>

                        <p className="mt-3 border-t border-[#00B6E8]/30 pt-3 text-xs text-[#0A2540]/70 dark:text-gray-400">
                            Solo se consideran términos presentes en ambas fuentes.
                        </p>
                    </div>
                </div>
            </div>
