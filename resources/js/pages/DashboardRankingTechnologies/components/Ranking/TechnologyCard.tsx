...
export default function TechnologyCard({ rank, data, onClick }: Props) {
  /* =========================================
     BLINDAJE DE DATOS
  ========================================= */
    ...
    >
      ...
      <div className="flex justify-between gap-6">
        ...
        <div className="flex-1 space-y-2">
          ...
          {data.category && (
            <div className="flex items-center gap-2 text-xs uppercase tracking-widest text-gray-700 dark:text-slate-300">
              <Cpu className="h-3 w-3 text-[#1CBCE8]" />
              {data.category}
            </div>
          )}
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-500">
                  Score demanda: {laborScore.toFixed(1)}
                </span>
              </div>
              ...
              <div>
                ...
                <span className="text-[11px] text-gray-500">
                  Score tendencia: {trendScore.toFixed(1)}
                </span>
              </div>
            </div>
          </div>
