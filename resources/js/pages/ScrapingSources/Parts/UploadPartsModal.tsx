...
export default function UploadPartsModal({ open, onClose, sourceId }: Props) {
    ...
    const handleUpload = async () => {
        ...
        try {
            for (const file of filesRef.current) {
                ...
                await axios.post(`/scraping-sources/${sourceId}/parts`, form, {
                    headers: {
            ...
            Swal.fire("Listo", "Partes cargadas.", "success");
            onClose();
            location.reload();
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-lg">
                ...
                >
                    ...
                    <p className="text-sm text-gray-400 mt-1">o haz clic para buscarlos</p>
