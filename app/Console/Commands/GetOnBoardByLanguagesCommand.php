...
class GetOnBoardByLanguagesCommand extends Command
{
    ...
    protected $description = '🌐 Recorre todos los lenguajes y guarda ofertas laborales de GetOnBoard, registrando métricas para el Observatorio.';
        ...
        foreach ($languages as $languageId => $languageName) {
            ...
            for ($page = 1; $page <= $pages; $page++) {
                ...
                try {
                    ...
                    if ($response->failed()) {
                        $this->warn("❌ Falló la API para {$languageName} (página {$page})");
                        continue;
                    }
