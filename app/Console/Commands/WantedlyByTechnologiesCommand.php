...
class WantedlyByTechnologiesCommand extends Command
{
    ...
    protected $description = '🇯🇵 Importa ofertas desde Wantedly (JP/SG) por tecnología, con traducción automática, modalidad estandarizada y geolocalización.';
        ...
        foreach ($technologies as $techId => $techName) {
            ...
            for ($page = 1; $page <= $pages; $page++) {
                ...
                try {
                    ...
                    Log::error("⚠️ Error en {$techName} (página {$page}): " . $e->getMessage());
