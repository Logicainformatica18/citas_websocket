...
class WantedlyByMethodologiesCommand extends Command
{
    ...
    protected $description = '🇯🇵 Importa ofertas desde Wantedly (JP/SG) por metodología, con traducción automática, modalidad estandarizada y geolocalización.';
        ...
        foreach ($methodologies as $methId => $methName) {
            ...
            for ($page = 1; $page <= $pages; $page++) {
                ...
                try {
                    ...
                    Log::error("⚠️ Error en {$methName} (página {$page}): " . $e->getMessage());
            ...
            $this->info("✅ {$methName}: {$totalNew} nuevas | 🌍 {$totalFound} encontradas");
        }
